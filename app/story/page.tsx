...
const historyItems: HistoryItem[] = [
  {
    ...
    title: "集められた開拓者たち。",
    paragraphs: [
      "昭和12年（1937年）4月20日、55人の開拓者たちは新たな暮らしと未来を築くため、若木の地へ入植しました。目の前に広がっていたのは、果樹園でも整えられた農地でもなく、どこまでも続く原野と松林。道も水も十分ではない土地で彼らは大地を耕し、若木を「人が暮らし、木々が育つ土地」へと変えていく歩みを始めました。",
    ],
    images: [
      {
  ...
  },
  {
    ...
    number: "04",
    year: "1950s",
    englishTitle: "SPIRIT OF UNITY",
    title: "団結の精神。",
    paragraphs: [
      "開拓者たちは固く結束し、長い年月をかけて農地を取り戻します。若木の歩みを支えたのは、一人ではなく、みんなで未来を切り拓くという団結の精神でした。",
      "そして取り戻した土地を今度は「守るため」に、再び彼らは結集し、若木の果樹栽培の地盤をさらに確かなものにする歩みを進めるのです。",
    ],
    images: [
      {
